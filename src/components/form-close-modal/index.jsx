...
const FormCloseModal = ({
  ...
  return (
    <Modal open={modelOpen} handleClose={cancelBtnHandler} className={style.main}>
      ...
      <div className={style.btnDiv}>
        ...
        />
        <Button text={confirmBtnText} btnClass={style.confirmBtn} onClick={confirmBtnHandler} data-cy = "bugreporting-discardchanging-btn" />
      </div>
    </Modal>
  );
};
