...
const EditorContainer = ({
  ...
  useEffect(() => {
    ...
    const hasBulletList = contentState
      .getBlockMap()
      .some((block) => block.getType() === 'unordered-list-item');
    const hasNumberList = contentState
      .getBlockMap()
      .some((block) => block.getType() === 'ordered-list-item');
    ...
    if (command === 'backspace') {
      ...
      if (
        ...
        if (
          ...
          if (newContent) {
            setEditorState(
              EditorState.push(editorState, newContent, 'remove-lists-item')
            );
            return 'handled';
          }
        }
