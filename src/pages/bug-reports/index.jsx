...
import TestCaseSummary from 'pages/projects/single-project/dashboard/cards/bugs-reported';
import DateRange from 'components/date-range';
import Menu from 'components/menu';

// NOTE: hooks
import { useShareableWidget } from 'hooks/api-hooks/projects/dashboard.hook';
...
const Index = () => {
  ...
  const { mutateAsync: _getWidgetData, isLoading } = useShareableWidget();
