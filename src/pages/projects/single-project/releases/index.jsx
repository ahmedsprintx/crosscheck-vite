    ...
    <>
      <div className={style.main}>
        <div className={style.header}>
          <Button
            text="Add Release"
            handleClick={() => setOpenAddRelease(true)}
          />
          <div>
            <MenuIcon />
          </div>
            ...
            <div className={style.cardMain} key={index}>
              <div className={style.card}>
                <p className={style.p}>
                  {ele.name}
                  {ele?.name.length > 28 && (
                    <span className={style.tooltip}>{ele.name}</span>
                  )}
                </p>
                <div
                  className={style.img}
              ...
              <div className={style.body}>
                ...
                <p className={style.para}>
                  In this sprint, we need to deliver test cases module along
                  with bugs reporting and user management.
                </p>
      ...
      />
      <AddRelease
        openAddRelease={openAddRelease}
        setOpenAddRelease={setOpenAddRelease}
      />
    </>
  );
};
