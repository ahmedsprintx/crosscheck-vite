...
import { useAddWidgetConfig, useEditWidgetConfig } from 'hooks/api-hooks/projects/widget.hook';
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className={style.widgetPanel}>
          <div className={style.form}>
            ...
            <h4>Configure Feedback Form Fields</h4>
        ...
        <div className={style.infoWrapper}>
          <p>Please copy this code and insert into your source code file.</p>
