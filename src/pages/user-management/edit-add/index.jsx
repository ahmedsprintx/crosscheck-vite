...
import { useCreateUser, useGetUserById, useUpdateUser } from 'hooks/api-hooks/settings/user-management.hook';
...
import ImgAvatarIcon from 'components/icon-component/img-avatar';
                      ...
                      <>
                        <label className={style.camDiv} htmlFor="file">
                          {watch('profilePicture') ? (
                            <img src={watch('profilePicture') || avatar} alt="" />
                          ) : (
                            <ImgAvatarIcon />
                          )}
                          <input
