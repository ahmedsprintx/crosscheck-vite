...
const RetestModal = ({ openRetestModal, setOpenRetestModal, options, refetch }) => {
  ...
  const { data: _bugDetails } = useGetBugById(openRetestModal?.id);
  const { statusOptions } = options;

  const { mutateAsync: _retestHandler, isLoading } = useRetestBug();
...
RetestModal.propTypes = {
  openRetestModal: PropTypes.bool.isRequired,
  setOpenRetestModal: PropTypes.func.isRequired,
